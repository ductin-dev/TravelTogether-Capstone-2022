...
const CommentItem = (props: IProps) => {
    ...
    const { id, fullName, avatar, contentComment, isLocalGuide, idUser } = props;
            ...
            <View style={[styles.profileContainer]}>
                ...
                <View style={styles.contentComment}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <Text style={styles.textFullName} onPress={() => navigation.navigate(USER_PROFILE, idUser)}>{fullName} </Text>
